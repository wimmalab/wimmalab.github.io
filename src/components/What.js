    ...
    render() {
        return (
            <div className="what-content">
                ...
                <p>At WIMMA Lab, students gain experience on project-based teamwork in multi-functional teams. Students are guided to build culture and rules that enable their team to succeed.</p>
                <h3>We teach to execute</h3>
                <p>WIMMA Lab is all about building from an idea to execution. Virtual companies are coached to deliver a working demo each sprint; However, 
                    the goal is not to build quick and dirty demos, but solutions that can be tested in a production environment.</p>
                <div className="boxes">
                    <div className="visio">
                        <h3>Vision</h3>
                    ...
                    <div className="missio">
                        ...
                        <p>WIMMA Lab strives to provide a better overview of project-based teamwork, agile development methodologies and network students with companies.</p>
                    </div>
